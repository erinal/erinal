            ...
            <div id="main-stats">
                <div class="row-fluid stats-row">
                    <div class="span3 stat">
                        <div class="data">
                            <span class="number"><?php echo $info['visitors'];?></span>
                            个访客
                        </div>
                    ...
                    <div class="span3 stat">
                        <div class="data">
                            <span class="number"><?php echo $info['users'];?></span>
                            个用户
                        </div>
                    ...
                    <div class="span3 stat">
                        <div class="data">
                            <span class="number"><?php echo $info['articles'];?></span>
                            篇新文章
                        </div>
                        <span class="date">本日</span>
                    </div>
                    <div class="span3 stat last">
                        <div class="data">
                            <span class="number"><?php echo $info['comments'];?></span>
                            新评论
                        </div>
                        <span class="date">本日</span>
                    </div>
