            ...
            <div class="row-fluid table">
                <table class="table table-hover">
                    ...
                    <tr class="first">
                        ...
                        <td>
                            <?php
                                echo isset($article->article_category->click)?$article->article_category->click:"出错";
                            ?>
                        </td>
                        <?php var_dump($article);?>
                        <td>
                            <?php echo isset($article->article_category[0]->cateid)?$article->article_category[0]->cateid:"出错"; ?>
                        </td>
                        <td>
                            <?php
